...
package get_model_status_go_proto
...
func (x *GetModelStatusRequest) GetModelSpec() *model_go_proto.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
type ModelVersionStatus struct {
	...
	// Model status.
	Status *status_go_proto.StatusProto `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`
}
...
func (x *ModelVersionStatus) GetStatus() *status_go_proto.StatusProto {
	if x != nil {
		return x.Status
	}
	return nil
...
var file_tensorflow_serving_apis_get_model_status_proto_rawDesc = []byte{
	...
	0x57, 0x5a, 0x52, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x65,
	...
	0x69, 0x6e, 0x67, 0x2f, 0x67, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x67, 0x65, 0x74, 0x5f,
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x67, 0x6f, 0x5f,
...
var file_tensorflow_serving_apis_get_model_status_proto_goTypes = []interface{}{
	...
	(*status_go_proto.StatusProto)(nil), // 5: tensorflow.serving.StatusProto
}
