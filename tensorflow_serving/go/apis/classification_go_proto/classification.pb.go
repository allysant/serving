...
package classification_go_proto
...
func (x *ClassificationRequest) GetModelSpec() *model_go_proto.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
func (x *ClassificationRequest) GetInput() *input_go_proto.Input {
	if x != nil {
		return x.Input
	}
	return nil
...
func (x *ClassificationResponse) GetModelSpec() *model_go_proto.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
var file_tensorflow_serving_apis_classification_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x42, 0x55, 0x5a, 0x50, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77,
	0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x67, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x73,
...
var file_tensorflow_serving_apis_classification_proto_goTypes = []interface{}{
	...
	(*input_go_proto.Input)(nil),     // 6: tensorflow.serving.Input
}
