...
package get_model_metadata_go_proto
...
type SignatureDefMap struct {
	...
	SignatureDef map[string]*for_core_protos_go_proto.SignatureDef `protobuf:"bytes,1,rep,name=signature_def,json=signatureDef,proto3" json:"signature_def,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *GetModelMetadataRequest) GetModelSpec() *model_go_proto.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
func (x *GetModelMetadataResponse) GetModelSpec() *model_go_proto.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
var file_tensorflow_serving_apis_get_model_metadata_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x42, 0x59, 0x5a, 0x54, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x6e, 0x67, 0x2f, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x67, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x67,
	0x65, 0x74, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0xf8, 0x01, 0x01, 0x62, 0x06, 0x70,
...
var file_tensorflow_serving_apis_get_model_metadata_proto_goTypes = []interface{}{
	...
	(*model_go_proto.ModelSpec)(nil), // 5: tensorflow.serving.ModelSpec
	(*for_core_protos_go_proto.SignatureDef)(nil), // 6: tensorflow.SignatureDef
