...
import (
	...
	input_go_proto "github.com/tensorflow/serving/tensorflow_serving/go/apis/input_go_proto"
	model_go_proto "github.com/tensorflow/serving/tensorflow_serving/go/apis/model_go_proto"
...
type InferenceTask struct {
	...
	ModelSpec *model_go_proto.ModelSpec `protobuf:"bytes,1,opt,name=model_spec,json=modelSpec,proto3" json:"model_spec,omitempty"`
...
func (x *InferenceTask) GetModelSpec() *model_go_proto.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
func (x *InferenceResult) GetModelSpec() *model_go_proto.ModelSpec {
	if x != nil {
		return x.ModelSpec
	}
	return nil
...
func (x *InferenceResult) GetClassificationResult() *classification_go_proto.ClassificationResult {
...
func (x *InferenceResult) GetRegressionResult() *regression_go_proto.RegressionResult {
...
type InferenceResult_ClassificationResult struct {
	ClassificationResult *classification_go_proto.ClassificationResult `protobuf:"bytes,2,opt,name=classification_result,json=classificationResult,proto3,oneof"`
}

type InferenceResult_RegressionResult struct {
	RegressionResult *regression_go_proto.RegressionResult `protobuf:"bytes,3,opt,name=regression_result,json=regressionResult,proto3,oneof"`
}
...
type MultiInferenceRequest struct {
	...
	// Input data.
	Input *input_go_proto.Input `protobuf:"bytes,2,opt,name=input,proto3" json:"input,omitempty"`
}
...
func (x *MultiInferenceRequest) GetInput() *input_go_proto.Input {
	if x != nil {
		return x.Input
	}
	return nil
...
var file_tensorflow_serving_apis_inference_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x42, 0x50,
	0x5a, 0x4b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x65, 0x6e,
	...
	0x6e, 0x67, 0x2f, 0x67, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x69, 0x6e, 0x66, 0x65, 0x72,
	0x65, 0x6e, 0x63, 0x65, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0xf8, 0x01, 0x01,
...
var file_tensorflow_serving_apis_inference_proto_goTypes = []interface{}{
	...
	(*model_go_proto.ModelSpec)(nil),                     // 4: tensorflow.serving.ModelSpec
	(*classification_go_proto.ClassificationResult)(nil), // 5: tensorflow.serving.ClassificationResult
	(*regression_go_proto.RegressionResult)(nil),         // 6: tensorflow.serving.RegressionResult
	(*input_go_proto.Input)(nil),                         // 7: tensorflow.serving.Input
}
