...
package input_go_proto

import (
	example_go_proto "github.com/tensorflow/tensorflow/tensorflow/go/core/example/example_go_proto"
...
type ExampleList struct {
	...
	Examples []*example_go_proto.Example `protobuf:"bytes,1,rep,name=examples,proto3" json:"examples,omitempty"`
}
...
func (x *ExampleList) GetExamples() []*example_go_proto.Example {
	if x != nil {
		return x.Examples
	}
	return nil
...
type ExampleListWithContext struct {
	...
	Examples []*example_go_proto.Example `protobuf:"bytes,1,rep,name=examples,proto3" json:"examples,omitempty"`
	Context  *example_go_proto.Example   `protobuf:"bytes,2,opt,name=context,proto3" json:"context,omitempty"`
}
...
func (x *ExampleListWithContext) GetExamples() []*example_go_proto.Example {
	if x != nil {
		return x.Examples
	}
	return nil
...
func (x *ExampleListWithContext) GetContext() *example_go_proto.Example {
	if x != nil {
		return x.Context
	}
	return nil
...
var file_tensorflow_serving_apis_input_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x64, 0x42, 0x4c, 0x5a, 0x47, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x2f, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x6e, 0x67, 0x2f, 0x74, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x5f,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x6e, 0x67, 0x2f, 0x67, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f,
	0x69, 0x6e, 0x70, 0x75, 0x74, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0xf8, 0x01,
...
var file_tensorflow_serving_apis_input_proto_goTypes = []interface{}{
	...
	(*example_go_proto.Example)(nil), // 3: tensorflow.Example
}
